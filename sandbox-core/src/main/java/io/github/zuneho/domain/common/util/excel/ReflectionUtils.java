...
public final class ReflectionUtils {
     ...
     * @param object       the object
     * @param fieldName    the name of the field
     * @param argumentType the type to be passed to the setter
     * @return the setter method
     * @throws NullPointerException        if object, fieldName or fieldType is null
     * @throws RuntimeException if the setter doesn't exist or is not visible
     */
     ...
     *
     * @param clazz        the class containing the setter
